                ...
                <article class="item-post">
                    <div class="post-thumb">
                        <a href="{{ route('category.show', $category->slug) }}">
                            <img class="thumbnail" src="{{ $category->image ? $category->image : '/storage/default/thumbnail-default.gif' }}" alt="">
                        </a>
                    </div>
                    <div class="post-meta">
                        <div class="meta">
                            <h4><a href="{{ route('category.show', $category->slug) }}">{{ $category->title }}</a></h4>
                            <p><i class="fa fa-clock-o"></i> Posted on {{ $category->created_at->format('d M. Y') }} under Categories</p>
                        </div>
                    </div>
